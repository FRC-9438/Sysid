...
public final class Constants {
  public static final class DriveConstants {
    ...
    private static final int krotationsPerSecond = 5676 * 60;
    ...
    public static final double kWheelDiameterMeters = Units.inchesToMeters(18.84);
    ...
    public static final double kEncoderDistancePerPulse =
        ...
        public static final double KlinearDistanceConversionFactor = kWheelDiameterMeters / kGearRatio;
